F-- Eliminar la base de datos jardineria si existe
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'jardineria')
BEGIN
    DROP DATABASE jardineria;
END;
GO

-- Crear y usar la base de datos jardineria
...
CREATE TABLE gama_producto (
  ...
  descripcion_texto NVARCHAR(50) NOT NULL,
  descripcion_html NVARCHAR(50) DEFAULT NULL,
  imagen NVARCHAR(256) DEFAULT NULL,
...
CREATE TABLE oficina (
  codigo_oficina NVARCHAR(10) NOT NULL,
  ciudad NVARCHAR(30) NOT NULL,
  pais NVARCHAR(50) NOT NULL,
  region NVARCHAR(50) DEFAULT NULL,
  codigo_postal NVARCHAR(10) NOT NULL,
  telefono NVARCHAR(20) NOT NULL,
  linea_direccion1 NVARCHAR(50) NOT NULL,
  linea_direccion2 NVARCHAR(50) DEFAULT NULL,
...
CREATE TABLE empleado (
  ...
  apellido2 NVARCHAR(50) DEFAULT NULL,
  extension NVARCHAR(10) NOT NULL,
  email NVARCHAR(100) NOT NULL,
  codigo_oficina NVARCHAR(10) NOT NULL,
  codigo_jefe INT DEFAULT NULL,
  puesto NVARCHAR(50) DEFAULT NULL,
...
CREATE TABLE cliente (
  ...
  nombre_contacto NVARCHAR(30) DEFAULT NULL,
  apellido_contacto NVARCHAR(30) DEFAULT NULL,
  ...
  region NVARCHAR(50) DEFAULT NULL,
  pais NVARCHAR(50) DEFAULT NULL,
  codigo_postal NVARCHAR(10) DEFAULT NULL,
...
CREATE TABLE pago (
  codigo_cliente INT NOT NULL,
  forma_pago NVARCHAR(40) NOT NULL,
...
CREATE TABLE producto (
  ...
  gama NVARCHAR(50) NOT NULL,
  dimensiones NVARCHAR(25) DEFAULT NULL,
  proveedor NVARCHAR(50) DEFAULT NULL,
...
CREATE TABLE pedido (
  ...
  codigo_cliente INT NOT NULL,
  CONSTRAINT ck_pedido_estado CHECK (estado IN ('Entregado', 'Pendiente', 'Rechazado')),
...
CREATE TABLE linea_pedido (
  ...
  CONSTRAINT pk_linea_pedido PRIMARY KEY (codigo_pedido, numero_linea),
  CONSTRAINT fk_linea_pedido_pedido FOREIGN KEY (codigo_pedido) REFERENCES pedido (codigo_pedido),
  CONSTRAINT fk_linea_pedido_producto FOREIGN KEY (codigo_producto) REFERENCES producto (codigo_producto)
);
GO

-- Insertar datos en la tabla gama_producto
INSERT INTO gama_producto(gama, descripcion_texto, descripcion_html, imagen) VALUES ('Aromáticas','Plantas aromáticas',NULL,NULL),
...
INSERT INTO oficina(codigo_oficina, ciudad, pais, region, codigo_postal, telefono, linea_direccion1, linea_direccion2) VALUES ('BCN-ES','Barcelona','España','Barcelona','08019','+34 93 3561182','Avenida Diagonal, 38','3A escalera Derecha'),
...
('PAR-FR','Paris','Francia','EMEA','75017','+33 14 723 4404','29 Rue Jouffroy abbans',''),
...
INSERT INTO cliente(codigo_cliente, nombre_cliente, nombre_contacto, apellido_contacto, telefono, fax, linea_direccion1, linea_direccion2, ciudad, region, pais, codigo_postal, codigo_empleado_rep_ventas, limite_credito) VALUES (1,'GoldFish Garden','Daniel G','GoldFish','5556901745','5556901746','False Street 52 2 A',NULL,'San Francisco',NULL,'USA','24006',19,3000.00),
  ...
  (6,'Lasas S.A.','Antonio','Lasas','34916540145','34914851312','Calle Leganes 15',NULL,'Fuenlabrada','Madrid','Spain','28945',8,154310.00),
  (7,'Beragua','Jose','Bermejo','654987321','916549872','Calle pintor segundo','Getafe','Madrid','Madrid','Spain','28942',11,20000.00),
  (8,'Club Golf Puerta del hierro','Paco','Lopez','62456810','919535678','Calle sinesio delgado','Madrid','Madrid','Madrid','Spain','28930',11,40000.00),
  (9,'Naturagua','Guillermo','Rengifo','689234750','916428956','Calle majadahonda','Boadilla','Madrid','Madrid','Spain','28947',11,32000.00),
  (10,'DaraDistribuciones','David','Serrano','675598001','916421756','Calle azores','Fuenlabrada','Madrid','Madrid','Spain','28946',11,50000.00),
  (11,'Madrileña de riegos','Jose','Tacaño','655983045','916689215','Calle Lagañas','Fuenlabrada','Madrid','Madrid','Spain','28943',11,20000.00),
  (12,'Lasas S.A.','Antonio','Lasas','34916540145','34914851312','Calle Leganes 15',NULL,'Fuenlabrada','Madrid','Spain','28945',8,154310.00),
  (13,'Camunas Jardines S.L.','Pedro','Camunas','34914873241','34914871541','Calle Virgenes 45','Calle Princesas 2 1ºB','San Lorenzo del Escorial','Madrid','Spain','28145',8,16481.00),
  (14,'Dardena S.A.','Juan','Rodriguez','34912453217','34912484764','Calle Nueva York 74',NULL,'Madrid','Madrid','Spain','28003',8,321000.00),
  (15,'Jardin de Flores','Javier','Villar','654865643','914538776','Calle  Oña 34',NULL,'Madrid','Madrid','Spain','28950',30,40000.00),
  (16,'Flores Marivi','Maria','Rodriguez','666555444','912458657','Calle Leganes24',NULL,'Fuenlabrada','Madrid','Spain','28945',5,1500.00),
  (17,'Flowers, S.A','Beatriz','Fernandez','698754159','978453216','Calle Luis Salquillo4',NULL,'Montornes del valles','Barcelona','Spain','24586',5,3500.00),
  (18,'Naturajardin','Victoria','Cruz','612343529','916548735','Plaza Magallón 15',NULL,'Madrid','Madrid','Spain','28011',30,5050.00),
  (19,'Golf S.A.','Luis','Martinez','916458762','912354475','Calle Estancado',NULL,'Santa cruz de Tenerife','Islas Canarias','Spain','38297',12,30000.00),
  (20,'Americh Golf Management SL','Mario','Suarez','964493072','964493063','Calle Letardo',NULL,'Barcelona','Cataluña','Spain','12320',12,20000.00),
  (21,'Aloha','Cristian','Rodrigez','916485852','914489898','Calle Roman 3',NULL,'Canarias','Canarias','Spain','35488',12,50000.00),
  (22,'El Prat','Francisco','Camacho','916882323','916493211','Avenida Tibidabo',NULL,'Barcelona','Cataluña','Spain','12320',12,30000.00),
  (23,'Sotogrande','Maria','Santillana','915576622','914825645','Calle Paseo del Parque',NULL,'Sotogrande','Cadiz','Spain','11310',12,60000.00),
  (24,'Vivero Humanes','Federico','Gomez','654987690','916040875','Calle Miguel Echegaray 54',NULL,'Humanes','Madrid','Spain','28970',30,7430.00),
  (25,'Fuenla City','Tony','Muñoz Mena','675842139','915483754','Calle Callo 52',NULL,'Fuenlabrada','Madrid','Spain','28574',5,4500.00),
  ...
  (27,'Jardinerías Matías SL','Matías','San Martín','916544147','917897474','Calle Francisco Arce, Nº44','Bustarviejo','Madrid','Madrid','Spain','37845',9,100500.00),
  (28,'Agrojardin','Benito','Lopez','675432926','916549264','Calle Mar Caspio 43',NULL,'Getafe','Madrid','Spain','28904',30,8040.00),
  (29,'Top Campo','Joseluis','Sanchez','685746512','974315924','Calle Ibiza 32',NULL,'Humanes','Madrid','Spain','28574',5,5500.00),
  (30,'Jardineria Sara','Sara','Marquez','675124537','912475843','Calle Lima 1',NULL,'Fuenlabrada','Madrid','Spain','27584',5,7500.00),
  (31,'Campohermoso','Luis','Jimenez','645925376','916159116','Calle Peru 78',NULL,'Fuenlabrada','Madrid','Spain','28945',30,3250.00),
...
INSERT INTO pago(codigo_cliente, forma_pago, id_transaccion, fecha_pago, total) VALUES (1,'PayPal','ak-std-000001','2008-11-10',2000.00),
...
INSERT INTO pedido(codigo_pedido, fecha_pedido, fecha_esperada, fecha_entrega, estado, comentarios, codigo_cliente) VALUES (1,'2006-01-17','2006-01-19','2006-01-19','Entregado','Pagado a plazos',5),
...
INSERT INTO linea_pedido(codigo_pedido, codigo_producto, cantidad, precio_unidad, numero_linea) VALUES (1,'FR-67',10,70.00,3),
(1,'OR-127',40,4.00,1),
(1,'OR-141',25,4.00,2),
(1,'OR-241',15,19.00,4),
(1,'OR-99',23,14.00,5),
...
(48,'FR-102',1,18.00,1),
(48,'FR-103',1,25.00,2),
(48,'OR-234',50,64.00,3),
(48,'OR-236',45,49.00,4),
(48,'OR-237',50,19.00,5),
